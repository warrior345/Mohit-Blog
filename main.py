...
# Provide a User Loader callback
...
class User(UserMixin, db.Model):
    ...
    # relationship is specified on the parent, as referencing a collection of items represented by the child
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            flash("User doesn't exist or you typed wrong email.")
            return redirect(url_for('login'))
